...
girl_mapping_fwd0:
        ...
        .byte   <-16, $23, %00000001, <-8
        .byte   <-16, $24, %00000001, 0
        .byte   <-8, $33, %00000000, <-8
        .byte   <-8, $34, %00000000, 0
        .byte   $FF
...
girl_mapping_fwd1:
        ...
        .byte   <-9, $30, %00000000, <-13
        .byte   <-9, $31, %00000001, <-5
        .byte   <-9, $32, %00000000, 3
        .byte   $FF
...
girl_mapping_down0:
        .byte   <-32, $05, %00000001, <-8
        .byte   <-32, $05, %01000001, 0
        .byte   <-24, $25, %00000001, <-8
        .byte   <-24, $25, %01000001, 0
        .byte   <-16, $36, %00000000, <-8
        .byte   <-16, $37, %00000000, 0
        .byte   <-8, $35, %00000000, <-8
        .byte   <-8, $35, %01000000, 0
        .byte   $ff

girl_mapping_down1:
        .byte   <-33, $05, %00000001, <-8
        .byte   <-33, $05, %01000001, 0
        .byte   <-25, $06, %00000001, <-8
        .byte   <-25, $07, %00000001, 0
        .byte   <-17, $16, %00000000, <-8
        .byte   <-17, $17, %00000000, 0
...
girl_mapping_down2:
        ...
        .byte   <-17, $17, %01000000, <-8
        .byte   <-17, $16, %01000000, 0
        .byte   <-9, $27, %01000000, <-8
        .byte   <-9, $26, %01000000, 0
        .byte   $FF

girl_mapping_up0:
        .byte   <-32, $08, %00000001, <-8
        .byte   <-32, $08, %01000001, 0
        .byte   <-24, $28, %00000001, <-8
        .byte   <-24, $28, %01000001, 0
        .byte   <-16, $38, %00000000, <-8
        .byte   <-16, $39, %00000000, 0
        .byte   <-8, $35, %00000000, <-8
        .byte   <-8, $29, %00000000, 0
        .byte   $FF

girl_mapping_up1:
        .byte   <-33, $08, %00000001, <-8
        .byte   <-33, $08, %01000001, 0
        .byte   <-25, $18, %00000001, <-8
        .byte   <-25, $19, %00000001, 0
        .byte   <-17, $0a, %00000000, <-8
        .byte   <-17, $17, %00000000, 0
        .byte   <-9, $09, %00000000, <-8
        .byte   <-9, $27, %00000000, 0
        .byte   $FF
...
girl_mapping_up2:
        ...
        .byte   <-17, $17, %01000000, <-8
        .byte   <-17, $0a, %01000000, 0
        .byte   <-9, $27, %01000000, <-8
        .byte   <-9, $09, %01000000, 0
        .byte   $FF
